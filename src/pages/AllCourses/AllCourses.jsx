...
const Page1 = ({setPage}) =>{
    ...
    <div >
        <Helmet>
                <meta charSet="utf-8" />
                <title>Learn how to code online for Free | All courses | Zaio</title>
                ...
                <meta property="title" content="Learn how to code online for Free | All courses | Zaio" />
                ...
                <meta property="og:title" content="Learn how to code online for Free | All courses | Zaio" />
        ...
        <div className="container">
            <div className="sup-p2 text-align-left mt-5 pt-2">Select a learning path</div>
            <div className="row" >
